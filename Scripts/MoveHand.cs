...
namespace MixedReality.Toolkit.SpatialManipulation
{
    ...
    /// </summary>
    [AddComponentMenu("MRTK/Spatial Manipulation/Solvers/Move Hand")]
    public class MoveHand : Solver
    {
        ...
        public float SurfaceNormalOffset
        {
            ...
            set
            {
                ...
                UnityEngine.Debug.Assert(!UseDefaultSurfaceNormalOffset, $"The new value for SurfaceNormalOffset on the Tap to Place object will not be applied because UseDefaultSurfaceNormalOffset is true, set UseDefaultSurfaceNormalOffset to false.");
        ...
        protected override void Start()
        {
            ...
            UnityEngine.Debug.Assert(IsColliderPresent, $"The game object {gameObject.name} does not have a collider attached, please attach a collider to use Tap to Place");
